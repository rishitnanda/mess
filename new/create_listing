...
import { X, Calendar, Clock, IndianRupee, TrendingDown, Timer, Info } from 'lucide-react';
...
export default function CreateListing({ onClose, onSubmit, darkMode, userMessQR }: CreateListingProps) {
